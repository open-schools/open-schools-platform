...
from open_schools_platform.testing_examples.services import student_create
from open_schools_platform.testing_examples.tests.factories import SchoolFactory, SchoolCourseFactory
