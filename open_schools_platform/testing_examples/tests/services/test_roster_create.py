...
from open_schools_platform.testing_examples.tests.factories import (
    StudentFactory,
    SchoolCourseFactory
)

from open_schools_platform.testing_examples.models import Roster
from open_schools_platform.testing_examples.services import (
    roster_create,
...
class RosterCreateTests(TestCase):
    ...
    @patch('open_schools_platform.testing_examples.services.rosters.roster_validate_period')
