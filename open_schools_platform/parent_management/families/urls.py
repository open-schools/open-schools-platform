...
from open_schools_platform.parent_management.families.views import FamilyApi, FamilyStudentProfilesListApi, \
    FamiliesListApi, FamilyDeleteApi, InviteParentApi, FamiliesStudentInvitesListApi
...
urlpatterns = [
    ...
    path('/<uuid:family_id>/student-invitations', FamiliesStudentInvitesListApi.as_view(),
         name="student-invitations-list")
]
