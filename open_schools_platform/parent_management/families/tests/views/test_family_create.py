...
class FamilyCreateTests(TestCase):
    ...
    def test_successful_family_creation(self):
        ...
        for_family_creation_response = self.client.post(self.family_create_url, family_creation_data)
        self.assertEqual(201, for_family_creation_response.status_code)
