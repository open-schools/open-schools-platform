...
from open_schools_platform.marketplace_management.internal_modules.module_registry import ModuleRegistry
...
class ModuleManager:
    ...
    def initialize(self, app_id: str, org_id: UUID, config_data: dict | None = None) -> InternalModule:
        module: InternalModule = self.module_registry.get_module(app_id, org_id, config_data)
