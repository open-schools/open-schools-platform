...
urlpatterns = [
    path('', MultipleViewManager({'get': OrganizationListApi, 'post': OrganizationCreateApi}).as_view(),
    ...
    path('/<uuid:organization_id>/student-profile/<uuid:student_profile_id>/circles',
         QueriesCirclesOrganizationStudent.as_view(), name='queries-organization-student-profile'),
