...
urlpatterns = [
    ...
    path('/<uuid:organization_id>/student-profile/<uuid:student_profile_id>/queries', QueriesOrganizationStudent.as_view(), name='queries-organization-student-profile')]
