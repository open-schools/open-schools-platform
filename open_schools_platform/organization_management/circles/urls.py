...
from open_schools_platform.organization_management.circles.views import CreateCircleApi, GetCirclesApi, \
    ...
    CirclesStudentProfilesExportApi, InviteTeacherApi, CircleICalExportApi, CirclesICalExportApi
...
urlpatterns = [
    ...
    path('/<uuid:circle_id>', MultipleViewManager({'get': GetCircleApi, 'delete': CircleDeleteApi}).as_view(),
         name='circle'),
