...
from open_schools_platform.user_management.users.serializers import CreateCreationTokenSerializer
...
def create_valid_test_token() -> CreationToken:
    ...
    token_serializer = CreateCreationTokenSerializer(data=data)
