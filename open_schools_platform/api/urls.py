...
from open_schools_platform.marketplace_management.views import AppReviewViewSet
...
urlpatterns = [
    ...
    path(
        ...
        include((organization_management_urls, "organization-management")),
    ),
    ...
    path(
        "students-management/",
        include((students_management_urls, "students-management")),
    ),
    path("photos-management/", include((photos_management_urls, "photo-management"))),
    path(
        "history-management/", include((history_management_urls, "history-management"))
    ),
    path("ticket-management/", include((ticket_management_urls, "ticket-management"))),
    path(
        "marketplace-management/",
        include((marketplace_management_urls, "marketplace-management")),
    ),
    path(
