...
enrollment_agreement_management_urls = [
    path('document', include(('open_schools_platform.enrollment_agreement.urls', 'enrollment_agreement'))),
]
...
urlpatterns = [
    ...
    path('enrollment_agreement/', include((enrollment_agreement_management_urls, 'enrollment_agreement'))),
